...
class worksheetGUI(F.BoxLayout):
    """
    ...
    def __init__(self, **kwargs):
        ...
        # Init worksheet dictionary and file types (date, worksheet, ...)
        self.worksheet = {'worksheet': str, 'date':str}
        self.worksheet['date'] = datetime.date.today().strftime("%d.%m.%Y")
...
class worksheetGUIApp(App):
    def build(self):
        self.title = 'Worksheet Generator'
        return worksheetGUI()  # Main widget, root
